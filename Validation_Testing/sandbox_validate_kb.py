...
def sanity_score(element:str, reg_title:str, reg_section:str, quote:str)->float:
...
def main():
    ...
    for f in facts:
        ...
        for s in f.get("regulatory_support", []):
            ...
            pen = sanity_score(f.get("element",""), s.get("reg_title",""), s.get("reg_section",""), s.get("quote",""))
