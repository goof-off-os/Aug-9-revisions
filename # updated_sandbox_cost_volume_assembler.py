...
def main():
    ...
    for e in wanted_order:
        ...
        if e in by_elem:
            ...
            cites.append("- _No citations extracted; review RFP for {e}_")
        cite_block = "\n".join(cites) if cites else "- _No citations extracted_"
        tmpl = TEMPLATES.get(e, f"#### {e}\n- Classification: Unknown\n- Basis of Estimate (placeholder): Review RFP for details.\n- Compliance: Check FAR/DFARS.\n{{citations}}\n")
